...
df1 = pytrend.interest_by_region(resolution='DMA',inc_low_vol=True,inc_geo_code=True)
df1_a = pytrend.interest_over_time()
print(df1_a.head(20))
...
result_NY = result[(result.index).isin(NY_counties)]
print(result.index)
